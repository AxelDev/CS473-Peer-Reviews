...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        DefaultModel.RegisterContext(typeof(PeerReviewModel.PeerReviewEntities1), new ContextConfiguration() { ScaffoldAllTables = true });
    ...
    void Application_Start(object sender, EventArgs e) {
        ...
        PeerReviewDemo.BundleConfig.RegisterBundles(BundleTable.Bundles);
        PeerReviewDemo.AuthConfig.RegisterOpenAuth();
    }
